...
import { pageTransition, fadeUp, fadeInLeft, fadeInRight, stagger } from "../animations";
...
function ServiceLinkCard({ to, icon, title, description, direction = "left", delay = 0 }) {
  return (
    <motion.div
...
function ServiceOverview() {
  return (
    <div className="max-w-5xl mx-auto py-16 px-4">
      <SectionHeading className="text-3xl mb-10">Vizsgálati területeink</SectionHeading>
      <div className="grid md:grid-cols-2 gap-6">
        <ServiceLinkCard
          to="/szolgaltatasok#allategeszsegugy"
          icon="🧫"
          title="Állategészségügyi diagnosztika"
          description="Integrációs, döntéstámogató vizsgálatok – mikrobiológiai tenyésztés, antibiotikum-érzékenység, parazitológia."
          direction="left"
        />
        <ServiceLinkCard
          ...
          description="Gyors higiéniai és mikrobiológiai kontroll – DIP Slide tesztek, vízhigiéniai ellenőrzés."
          direction="right"
          delay={0.1}
        />
      </div>
